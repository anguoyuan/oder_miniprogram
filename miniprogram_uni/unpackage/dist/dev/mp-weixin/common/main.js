...
var _index = _interopRequireDefault(__webpack_require__(/*! @/uni_modules/zp-mixins/index.js */ 43));
...
/* harmony import */ var _App_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App.vue?vue&type=style&index=0&lang=css& */ 40);
...
var _default = {
  ...
  globalData: {
    ...
    addToCart: function addToCart(item) {
      var existIndex = this.cart.findIndex(function (cartItem) {
      ...
      if (existIndex >= 0) {
        ...
        var newCartId = Date.now() + Math.random();
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(!_this.isLogin || _this.cart.length === 0)) {
                  _context.next = 2;
                  break;
                }
              ...
              case 2:
                _context.prev = 2;
                api = __webpack_require__(/*! ./utils/api.js */ 38); // 先清空后端购物车
                _context.next = 6;
                return api.clearCart();
              case 6:
                // 同步本地购物车到后端
                _iterator = _createForOfIteratorHelper(_this.cart);
                _context.prev = 7;
                _iterator.s();
              case 9:
              ...
              case 26:
                ...
                console.log('CatchClause', _context.t1);
                console.error('同步购物车失败', _context.t1);
              case 31:
              case "end":
                return _context.stop();
            }
          }
        }, _callee, null, [[2, 26], [7, 17, 20, 23]]);
      }))();
    }
  },
  onLaunch: function onLaunch() {
    ...
    var guestId = uni.getStorageSync('guestId');
    if (!guestId) {
