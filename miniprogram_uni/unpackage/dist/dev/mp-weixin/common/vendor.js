...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"依额点心","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 30 */
/*!*********************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/pages.json ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 37 */
/*!********************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/config.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 38 */
/*!***********************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/utils/api.js ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

// API接口封装
var request = __webpack_require__(/*! ./request.js */ 39);
...
function getProductsByCategory(categoryId) {
  return request.get("/product/list/".concat(categoryId));
}
...
function getProductDetail(productId) {
  return request.get("/product/detail/".concat(productId));
}
...
function removeCartItem(cartId) {
  return request.delete("/cart/remove/".concat(cartId));
}
...
function getOrderDetail(orderId) {
  return request.get("/order/detail/".concat(orderId));
}
...
function removeFavorite(productId) {
  return request.delete("/favorite/remove?productId=".concat(productId));
}
...
function removeLike(productId) {
  return request.delete("/like/remove?productId=".concat(productId));
}
function getLikes() {
...
function deleteAddress(addressId) {
  return request.delete("/address/delete/".concat(addressId));
}
...
function setDefaultAddress(addressId) {
  return request.put("/address/setDefault/".concat(addressId));
}
...
function getOrderReview(orderId) {
  return request.get("/review/order/".concat(orderId));
}
...
function checkHasReviewed(orderId) {
  return request.get("/review/order/".concat(orderId, "/hasReviewed"));
}
module.exports = {
  wxLogin: wxLogin,
...
/* 39 */
/*!***************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/utils/request.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {// utils/request.js - 统一请求封装
...
function request(url) {
  ...
  var needAuth = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  return new Promise(function (resolve, reject) {
    var header = {
...
module.exports = {
  ...
  post: function post(url, data, needAuth) {
...
/* 43 */
/*!*****************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/index.js ***!
  \*****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _pageLifetimes = __webpack_require__(/*! ./lifecycle/pageLifetimes */ 44);
var _clone = __webpack_require__(/*! ./methods/clone */ 45);
var _dataset = __webpack_require__(/*! ./methods/dataset */ 46);
var _escape = __webpack_require__(/*! ./methods/escape */ 47);
var _event = __webpack_require__(/*! ./methods/event */ 48);
var _getTabBar = __webpack_require__(/*! ./methods/getTabBar */ 49);
var _relation = __webpack_require__(/*! ./methods/relation */ 50);
var _selectComponent = __webpack_require__(/*! ./methods/selectComponent */ 51);
var _setData = __webpack_require__(/*! ./methods/setData */ 52);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var _default = {
...
/* 44 */
/*!***********************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/lifecycle/pageLifetimes.js ***!
  \***********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 45 */
/*!*************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/methods/clone.js ***!
  \*************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 46 */
/*!***************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/methods/dataset.js ***!
  \***************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 47 */
/*!**************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/methods/escape.js ***!
  \**************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 48 */
/*!*************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/methods/event.js ***!
  \*************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 49 */
/*!*****************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/methods/getTabBar.js ***!
  \*****************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 50 */
/*!****************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/methods/relation.js ***!
  \****************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 51 */
/*!***********************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/methods/selectComponent.js ***!
  \***********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 52 */
/*!***************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/methods/setData.js ***!
  \***************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _set2 = _interopRequireDefault(__webpack_require__(/*! ../utils/_set */ 53));
var _debounce = _interopRequireDefault(__webpack_require__(/*! ../utils/debounce */ 54));
/**
 * 老setData polyfill
...
/* 53 */
/*!**********************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/utils/_set.js ***!
  \**********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 54 */
/*!**************************************************************************************************************************!*\
  !*** C:/Users/songk/Downloads/order-system-tea-backend-node_uni/miniprogram_uni/uni_modules/zp-mixins/utils/debounce.js ***!
  \**************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
